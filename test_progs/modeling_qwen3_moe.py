...
#                🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨
# REFERENCE IMPLEMENTATION COPY FOR QWEN3-30B-A3B.
# This Hugging Face Transformers implementation defines the Qwen3-MoE layers
# used by Qwen/Qwen3-30B-A3B. It is kept under test_progs as a reference for
# implementing and validating nanovllm/models/qwen3_moe.py; it is not the
# nano-vLLM runtime implementation.
#
